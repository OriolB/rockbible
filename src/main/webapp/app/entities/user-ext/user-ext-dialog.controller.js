(function() {
    ...
    UserExtDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'DataUtils', 'entity', 'UserExt', 'User', 'VotarFavoritoM', 'VotarFavoritoB', 'VotarFavoritoA', 'VotarFavoritoC'];

    function UserExtDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, DataUtils, entity, UserExt, User, VotarFavoritoM, VotarFavoritoB, VotarFavoritoA, VotarFavoritoC) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('appApp:userExtUpdate', result);
